...
async function scrapeYokAtlas() {
  ...
  const links = [
    {
      url: 'https://yokatlas.yok.gov.tr/tercih-sihirbazi-t3-tablo.php?p=tyt',
      category: 'tyt',
    },
  ];
  ...
  try {
            ...
            const programAdi = await page.evaluate((rowIndex) => {
              try {
                const element = document.evaluate(
                  `/html/body/div[3]/div[2]/div/div/div[2]/div/table/tbody/tr[${
                    rowIndex + 1
                  }]/td[4]/strong`,
                  document,
                  null,
    ...
    console.log('All data has been saved to "yok_atlas_tyt_results.json".');
